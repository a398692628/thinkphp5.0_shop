    ...
    $.extend({
        survey:function(options){
            ...
            var __feedCreat = function(){
                ...
                //feedHtml.html('<a class="' + survClass +'" href="http://service.zol.com.cn/complain/" id="callSurvey" title="建议反馈" target="blank">建议反馈</a><a class="'+ backTopClass +'" href="javascript:void(0)" style="display:none" id="backTop" title="返回顶部">返回顶部</a>');
                feedHtml.html('<a class="'+ backTopClass +'" href="javascript:void(0)" style="display:none" id="backTop" title="返回顶部">返回顶部</a>');
